  ...
  return (
    <Layout>
      <div className="p-8 animate-fade-in-up">
        <div className="mb-8">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Billings & Subscription</h2>
          <p className="text-gray-600 font-medium">Manage your subscription and view payment history</p>
        </div>

        {/* Current Subscription */}
        <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl p-6 mb-8 text-white card-hover transition-smooth">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 mb-1 font-medium">Current Plan</p>
            ...
            <div className="text-right">
              <p className="text-purple-100 mb-1 font-medium">Device Limit</p>
              <p className="text-4xl font-bold">{user?.max_devices || 1}</p>
              <p className="text-sm text-purple-200 mt-1 font-semibold">devices</p>
            </div>
          </div>
        </div>
        ...
        {/* Available Packages */}
        <div className="mb-8">
          <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-4">Available Plans</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {packages.map((pkg) => (
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm font-medium mb-4">{pkg.description}</p>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-4 py-3 rounded-xl font-semibold transition-smooth disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        {/* Payment History */}
        <div>
          <h3 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-4">Payment History</h3>
          ...
          {payments.length === 0 ? (
            ...
            <div className="card-soft card-hover rounded-xl overflow-hidden transition-smooth">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {payments.map((payment) => (
                    <tr key={payment.id} className="hover:bg-gradient-subtle transition-smooth">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-xl ${
                          payment.status === 'paid'
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {payment.status === 'pending' && payment.chip_purchase_id ? (
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-xl font-semibold transition-smooth disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-xl font-semibold transition-smooth"
                          >
